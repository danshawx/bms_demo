...
#include "lis2dw12xd.h"

LOG_MODULE_REGISTER(LIS2DW12XD, CONFIG_SENSOR_LOG_LEVEL);
...
static int lis2dw12_init(const struct device *dev)
{
	...
	/* set power mode */
	if (lis2dw12_set_power_mode(lis2dw12, CONFIG_LIS2DW12XD_POWER_MODE)) {
		return -EIO;
	}
...
const struct lis2dw12_device_config lis2dw12_cfg = {
	...
	.pm = CONFIG_LIS2DW12XD_POWER_MODE,
#ifdef CONFIG_LIS2DW12XD_TRIGGER
...
#if defined(CONFIG_LIS2DW12XD_INT_PIN_1)
	.int_pin = 1,
#elif defined(CONFIG_LIS2DW12XD_INT_PIN_2)
	.int_pin = 2,
#endif /* CONFIG_LIS2DW12XD_INT_PIN */

#ifdef CONFIG_LIS2DW12XD_PULSE
#if defined(CONFIG_LIS2DW12XD_ONLY_SINGLE)
	.pulse_trigger = LIS2DW12_ONLY_SINGLE,
#elif defined(CONFIG_LIS2DW12XD_SINGLE_DOUBLE)
	.pulse_trigger = LIS2DW12_BOTH_SINGLE_DOUBLE,
#endif
	.pulse_ths[0] = CONFIG_LIS2DW12XD_PULSE_THSX,
	.pulse_ths[1] = CONFIG_LIS2DW12XD_PULSE_THSY,
	.pulse_ths[2] = CONFIG_LIS2DW12XD_PULSE_THSZ,
	.pulse_shock = CONFIG_LIS2DW12XD_PULSE_SHOCK,
	.pulse_ltncy = CONFIG_LIS2DW12XD_PULSE_LTNCY,
	.pulse_quiet = CONFIG_LIS2DW12XD_PULSE_QUIET,
#endif /* CONFIG_LIS2DW12XD_PULSE */
#endif /* CONFIG_LIS2DW12XD_TRIGGER */
};
