...
LOG_MODULE_DECLARE(LIS2DW12XD, CONFIG_SENSOR_LOG_LEVEL);
...
#endif /* CONFIG_LIS2DW12XD_TRIGGER_OWN_THREAD */
}

#ifdef CONFIG_LIS2DW12XD_TRIGGER_OWN_THREAD
...
#ifdef CONFIG_LIS2DW12XD_TRIGGER_GLOBAL_THREAD
...
int lis2dw12_init_interrupt(const struct device *dev)
{
	...
	k_thread_create(&lis2dw12->thread, lis2dw12->thread_stack,
		       CONFIG_LIS2DW12XD_THREAD_STACK_SIZE,
		       (k_thread_entry_t)lis2dw12_thread, lis2dw12,
		       NULL, NULL, K_PRIO_COOP(CONFIG_LIS2DW12XD_THREAD_PRIORITY),
		       0, K_NO_WAIT);
#elif defined(CONFIG_LIS2DW12XD_TRIGGER_GLOBAL_THREAD)
