...
enum sensor_channel {
    ...
    // bq769x2
    SENSOR_CHAN_MONITOR_VOLTAGE,
    SENSOR_CHAN_MONITOR_CC1,
    SENSOR_CHAN_MONITOR_CC2,
    SENSOR_CHAN_MONITOR_TS1,
    SENSOR_CHAN_MONITOR_TS2,
    SENSOR_CHAN_MONITOR_TS3,
    SENSOR_CHAN_MONITOR_INTER_TS,
    SENSOR_CHAN_MONITOR_FAULTS,
	SENSOR_CHAN_MONITOR_FET_STATUS,
...
enum sensor_trigger_type {
	...
	// bq769x2
	SENSOR_TRIG_MONITOR_FET_CONTROL,
	SENSOR_TRIG_MONITOR_CB_ACTIVE_CELLS,
